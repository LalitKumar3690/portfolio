...
const Navbar = () => {
  ...
  return (
    <nav className='w-full fixed top-0 left-0 z-50 h-16 bg-gray-800 text-white flex justify-between items-center px-4'>
      ...
      <motion.div 
        ...
        className={`fixed top-16 right-0 w-full h-full bg-[#0e141b] text-black shadow-lg md:hidden ${menuOpen ? 'block' : 'hidden'}`}>
      ...
      <motion.div 
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          className='absolute w-[25rem] h-full text-black bg-[#0e141b] right-0 top-0 p-10 lg:p-4'>
